...
let mockLoadResult: Array<IRecord>;
const mockLoadFn = async function (fields: Array<string>, filter: string, maxRows: number) {
...
export const getMockDataSource = () => {
    ...
    const ds = new MySqlDatasource('User');
    ds.fieldDefs = mockFieldDefs;
    return ds;
};